...
urlpatterns = [
    ...
    url(r'^info-edit/$', views.InfoEdit, name='info_edit'),
    ...
    url(r'^commodity/(?P<pk>\d+)/edit/$', views.CommodityEdit, name='commodity_edit'),
    url(r'^commodity/(?P<pk>\d+)/delete/$', views.CommodityDelete, name='commodity_delete'),
